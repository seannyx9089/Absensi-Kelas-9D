...
function Home() {
  ...
  const toggleAttendance = () => { setAttendanceOpen((open) => !open); setNotice(attendanceOpen ? "Sesi absensi ditutup." : "Sesi absensi dibuka untuk guru."); };
