...
function Home({ teacherOnly = false }: { teacherOnly?: boolean }) {
  ...
  return (
    <div className="min-h-screen overflow-x-hidden bg-[#F5F0E6] text-[#243447]">
      ...
      <main>
        <section id="beranda" className={`relative overflow-hidden border-b border-[#0A2540]/8 ${teacherOnly ? "hidden" : ""}`}>
